              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">
                  ...
                  <div  style="display: flex;">
                    <div v-for="(gameShop, index) in GAMESPLATFORM" :key="index" class="platform" :style="{backgroundColor: getColorForPlatform(gameShop.shop)}">
                      <a :href="gameShop.urlPage" target="_blank"><div>{{gameShop.shop}}</div></a>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
                  <div >Platform: 
                    <div v-for="(gamePlatform, index) in GAMESPLATFORM" :key="index" style="margin-top: 5px; display: flex;">
                ...
                <li class="list-group-item">
                  <div >Precio actual: 
                    <div v-for="(game, index) in GAMESPLATFORM" :key="index" style="margin-top: 5px; display: flex;">
                      <div class="circle" :style="{backgroundColor : getColorForPlatform(game.shop)}"></div><div class="price">{{ game.actualPrice }} €</div>
                    </div>
                  </div>
                </li>
                <li class="list-group-item">
                  <div>Precio más alto que ha tenido:
                    <div style="margin-top: 5px;">
                      {{ gethigherPriced(GAME.higherPrice) }} €
                    </div>
                  </div>
                </li>
              </ul>
